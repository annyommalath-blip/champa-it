  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      {location.pathname === "/" ? (
        ...
        <header className="md:hidden px-5 min-h-[56px] safe-area-top pt-4 pb-2 glass-header sticky top-0 z-50 border-b border-border/30 flex items-center justify-between">
